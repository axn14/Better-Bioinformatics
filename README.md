...
> **Companion guide:** [`INFERENCE_GUIDE.md`](INFERENCE_GUIDE.md) — a step-by-step checklist for
...
![main figure](shap_instability_main.png)
...
background pairs. See [`coabundance_check.png`](coabundance_check.png).
...
what to verify *before* you trust SHAP at all— is in [`INFERENCE_GUIDE.md`](INFERENCE_GUIDE.md).

## 8. Repo layout
```
shap_instability_demo.py     # the whole demo (data -> CLR -> SHAP -> bootstrap -> figures)
INFERENCE_GUIDE.md           # how to make defensible inferences from SHAP
